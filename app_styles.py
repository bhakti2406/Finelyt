...
/* Scoped column/container settings inside header to allow floating panels */
div.st-key-global_header div[data-testid="column"] {
    overflow: visible !important;
}
div.st-key-global_header .stVerticalBlock {
    overflow: visible !important;
}
div.st-key-global_header .element-container {
    overflow: visible !important;
}
div.st-key-global_header div.stHtml {
    overflow: visible !important;
}

/* Mega Navigation Bar Container */
.mega-nav {
    display: flex;
    align-items: center;
    ...
    border-radius: 24px;
    padding: 6px 20px;
    box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37), 0 0 15px rgba(0, 242, 168, 0.02);
    width: 100%;
    position: relative;
    z-index: 10000;
}

/* Dropdown Menu Item (button + pop-out panel) */
.mega-nav-item {
    position: relative;
    padding: 8px 0;
    outline: none;
...
.mega-nav-btn:hover,
.mega-nav-item:hover .mega-nav-btn,
.mega-nav-item:focus-within .mega-nav-btn {
    color: var(--text-primary);
    background: rgba(255, 255, 255, 0.05);
}

.mega-nav-btn.active {
    background: linear-gradient(135deg, rgba(0, 242, 168, 0.1), rgba(0, 212, 255, 0.1)) !important;
    color: #00F2A8 !important;
    border: 1px solid rgba(0, 242, 168, 0.25) !important;
}
...
.mega-nav-item:hover .mega-nav-btn .arrow,
.mega-nav-item:focus-within .mega-nav-btn .arrow {
...
.mega-nav-item:focus-within .mega-dropdown-panel {
    opacity: 1;
    visibility: visible;
...
.dropdown-list-item.active {
    background: linear-gradient(135deg, rgba(0, 242, 168, 0.15), rgba(0, 212, 255, 0.15)) !important;
    border-color: rgba(0, 242, 168, 0.2) !important;
    color: #00F2A8 !important;
    font-weight: 600 !important;
}
...
@media (max-width: 768px) {
    ...
    #mobile-menu-cb:checked ~ .mega-nav-items-container {
        display: flex;
    }
...
div.st-key-alerts_button button div[data-testid="stMarkdownContainer"],
div.st-key-alerts_button_unread button div[data-testid="stMarkdownContainer"],
div.st-key-profile_button button div[data-testid="stMarkdownContainer"],
div.st-key-logout_button button div[data-testid="stMarkdownContainer"] {
    display: none !important;
}
