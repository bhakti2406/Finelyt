...
def show(user_id=1):
    ...
    # ── MODEL CONTROLS ────────────────────────────────────────────────────────
    st.markdown(
        '<p class="section-title">Model Controls & Documentation</p>',
        unsafe_allow_html=True)
    ...
    # Isolation Forest Comparison Documentation
    st.markdown("""
    <div style="background:var(--bg-card); border:1px solid var(--border); border-radius:12px; padding:1.2rem; margin-top:1rem;">
        <h5 style="color:var(--accent); margin:0 0 0.5rem 0; font-size:1.05rem;">Why Isolation Forest?</h5>
        <p style="font-size:0.85rem; color:var(--text-secondary); line-height:1.5;">
            FINELYT V2 utilizes an <strong>Isolation Forest</strong> algorithm to detect anomalous transaction patterns. Unlike traditional anomaly detectors that model normal points first, Isolation Forest explicitly isolates anomalies:
        </p>
        <ul style="font-size:0.85rem; color:var(--text-secondary); line-height:1.6; padding-left:20px; margin-bottom:1rem;">
            <li><strong>Works well with unlabeled data:</strong> Transactions don't need manual tags to detect outliers.</li>
            <li><strong>Detects rare spending anomalies:</strong> Highlights unusual spikes or combinations.</li>
            <li><strong>Scales efficiently:</strong> Linear time complexity makes it extremely fast.</li>
            <li><strong>Requires minimal feature engineering:</strong> Works directly on transaction amounts and date features.</li>
        </ul>
        <table style="width:100%; border-collapse:collapse; font-size:0.8rem; border:1px solid var(--border);">
            <thead>
                <tr style="background:var(--bg-elevated); height:32px;">
                    <th style="border:1px solid var(--border); padding:6px; text-align:left;">Algorithm</th>
                    <th style="border:1px solid var(--border); padding:6px;">Scaling</th>
                    <th style="border:1px solid var(--border); padding:6px;">Param Sensitivity</th>
                    <th style="border:1px solid var(--border); padding:6px;">Outlier Strategy</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td style="border:1px solid var(--border); padding:6px; font-weight:700; color:var(--text-primary);">Isolation Forest</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#10B981; font-weight:600;">Excellent (O(N))</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#10B981; font-weight:600;">Low</td>
                    <td style="border:1px solid var(--border); padding:6px; font-weight:700; color:#10B981;">Isolates Outliers Direct</td>
                </tr>
                <tr>
                    <td style="border:1px solid var(--border); padding:6px; font-weight:700; color:var(--text-primary);">One-Class SVM</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#EF4444; font-weight:600;">Poor (O(N^3))</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#EF4444; font-weight:600;">High</td>
                    <td style="border:1px solid var(--border); padding:6px;">Profiles Normal Data</td>
                </tr>
                <tr>
                    <td style="border:1px solid var(--border); padding:6px; font-weight:700; color:var(--text-primary);">Local Outlier Factor</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#F59E0B; font-weight:600;">Medium (O(N^2))</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#F59E0B; font-weight:600;">Medium</td>
                    <td style="border:1px solid var(--border); padding:6px;">Local Density Estimation</td>
                </tr>
                <tr>
                    <td style="border:1px solid var(--border); padding:6px; font-weight:700; color:var(--text-primary);">DBSCAN</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#F59E0B; font-weight:600;">Medium (O(N log N))</td>
                    <td style="border:1px solid var(--border); padding:6px; color:#EF4444; font-weight:600;">High (Epsilon)</td>
                    <td style="border:1px solid var(--border); padding:6px;">Density Cluster Noise</td>
                </tr>
            </tbody>
        </table>
    </div>
